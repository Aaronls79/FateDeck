    ...
    public class DataSource
    {
        ...
        private static void InitializeSchemes()
        {
            using (var cnn = Connection())
            {
                ...
                {
                    new Scheme(0,"A Line in the Sand","At the end of the game, the Crew earns 2 VP if it has at least four Scheme Markers on the Centerline.<br/><br/>If this Scheme is revealed, the Crew earns an additional VP if it has at least two Scheme markers on the Centerline at the end of the game.", 0, Suite.None, Source.CoreRulebook2ndEdition),
                    ...
                    new Scheme(0,"Protect Territory","At the end of the game, this Crew gains 1 VP for each of its Scheme Markers which is at least 6\" from its Deployment Zone and has at least one friendly non-Peon model within 2\" of it. Scheme Markers with more enemy models than friendly models within 2\" do not count towards this Scheme.<br/><br/>If this Scheme is revealed and this Crew earns at least 2 VP from this Scheme, it earns 1 additional VP.", 0, Suite.Tombs, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Bodyguard","The scheming player notes down a non-Leader Henchman or Enforcer model in her Crew that must be protected. If the Crew has no Henchmen or Enforcer models, note down the model with the highest Soulstone cost instead.<br/><br/>This Scheme may be revealed at any time. At the end of every Turn, starting on Turn 4, if this Scheme is revealed, this Crew earns 1 VP if the noted model is still in play and at least 8\" from its Deployment Zone. At the end of the game, this Crew earns 1 additional VP if the noted model is still in play with more than half of its Wounds remaining.", 0, Suite.Rams, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Cursed Object","All non-Peon models in this Crew may target a non-Peon enemy model within 1\" with a (1) Interact Action to give the target the following Condition for the rest of the game:<br/><br/>\"Cursed Object: This model may take a (1) Interact Action to perform a TN 12 Wk duel. If successful, remove this Condition from this model. No other Action may remove this Condition.\"<br/><br/> This Scheme starts the game unrevealed. The first time an enemy model gains the Cursed Object Condition, reveal this Scheme. At the end of every Turn after the first, this Crew may end the Cursed Object Condition on one enemy model to gain 1 VP.", 1, Suite.None, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Outflank","At the end of the game, this Crew earns 1 VP if it has a non-Peon model on the Centerline and within 3\" of the point where the Centerline meets the table edge (or corner). This Crew earns an additional 1 VP if it has another non-Peon model on the Centerline within 3\" of the opposite point where the Centerline meets the table edge (or corner). Models which are engaged with an enemy may not count towards this Scheme.<br/><br/> If this Scheme is revealed, this Crew earns an additional 1 VP if it has at least one non-Peon model within 3\" of the point where the Centerline meets the table edge (or corner).", 2, Suite.None, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Plant Evidence","At the end of the game, the Crew earns 1 VP for each piece of terrain in base contact with at least one of the Crew's Scheme Markers, if the Scheme Marker is within the Enemy Half of the table.<br/><br/>If this Scheme is revealed and this Crew earns at least 2 VP from this Scheme, it earns 1 additional VP.", 3, Suite.None, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Entourage","The scheming player chooses a Master or Henchman model in her crew. At the end of the game, if the chosen model is in the Enemy Half of the table, the Crew earns 1 VP.<br/><br/>If the chosen model is in the enemy's Deployment Zone at the end of the game the Crew earns 2 VP instead.<br/><br/>If this Scheme is revealed, this crew earns 1 additional VP if it earns any VP from this Scheme.", 4, Suite.None, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Vendetta","The scheming player notes one of her non-Leader, non-Peon models with a Soulstone cost greater than 0 and an enemy model with a Soulstone cost equal to or greater than her chosen model. If the noted friendly model's first Attack Action in the game is against the noted enemy model, score 1 VP and reveal this Scheme. If the noted enemy model is not in play at the end of the game, and this Scheme has been revealed, score 1 additional VP. If the noted enemy model is killed by the noted friendly model, score 3 VP (whether or not the Scheme was revealed).<br/><br/>This Scheme may not be revealed at the start of the game.", 5, Suite.None, Source.CoreRulebook2ndEdition),
                    new Scheme(0,"Plant Explosives","Once per game, at the end of any Turn, this Crew may reveal this Scheme and earn 1 VP for each enemy model that is within 3\" of at least one of this Crew's Scheme Markers. Then, remove all of this Crew's Scheme Markers which are within 3\" of an enemy model.<br/><br/>This Scheme does not benefit from being revealed.", 6, Suite.None, Source.CoreRulebook2ndEdition),
